# Generated by Django 3.1 on 2020-12-11 15:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(blank=True, default=datetime.datetime(2020, 12, 11, 16, 18, 40, 956559))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reponse_correctes', models.IntegerField(default=1)),
                ('id_question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='testdb.question')),
                ('id_reponse', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='testdb.reponse')),
                ('id_test', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='testdb.test')),
            ],
        ),
        migrations.AddField(
            model_name='question',
